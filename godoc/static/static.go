...
-->
	<p>需要更多包？看看<a href="/wiki/SubRepositories">子代码库</a>和<a href="/wiki/Projects">其它Go项目</a>吧！</p>
	{{end}}
{{end}}
`,
...
-->
		<h2 id="Textual">{{html $.Found}} 文本事件</h2>
	{{else}}
<!--
...
-->
		<h2 id="Textual">不只是 {{html $.Found}} 文本事件</h2>
		<p>
		<span class="alert" style="font-size:120%">并未显示所有包含 "{{html $.Query}}" 的文件或行。</span>
		</p>
	{{end}}
	<p>
	<table class="layout">
